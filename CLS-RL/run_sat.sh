...
# 记得修改grpo_sat.py中210行附近的加载sat数据集的路径信息
cd src/cls-rl
export DEBUG_MODE="true" # Enable Debug if you want to see the rollout of model during RL
export LOG_PATH="debug_log_2b_instruct_sat.txt"
# 增加了一行卡的设置
...
PYTHONIOENCODING=utf-8 python -m torch.distributed.run --nproc_per_node="1" \
    ...
    --master_port="29501" \
    src/open_r1/grpo_sat.py \
    --output_dir  'Qwen2-VL-2B-Instruct-SAT-generation4/'\
    ...
    --max_pixels 401408 \
    --num_train_epochs 2 \
    --run_name Qwen2-VL-2B-Instruct-SAT\
    --save_steps 10000 \
